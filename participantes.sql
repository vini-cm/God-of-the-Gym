...
CREATE TABLE `aula_aluno` (
  ...
  `id_aluno` varchar(14) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_aula_idx` (`id_aula`),
  KEY `id_aluno_idx` (`id_aluno`),
  CONSTRAINT `id_aluno` FOREIGN KEY (`id_aluno`) REFERENCES `clientes` (`cpf`) ON DELETE CASCADE,
  CONSTRAINT `id_aula` FOREIGN KEY (`id_aula`) REFERENCES `aulas` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-11-23 18:50:49
