...
public class AulaDAO extends genericoDAO{
    ...
    public void editar (Aula aula) throws SQLException{
        ...
        editar(update, aula.getNome(), aula.getData(),aula.getDescricao(), aula.getVagas(), aula.getNomeInst(), aula.getIdInst(), aula.getIdAula());
     }
    
    public void deletar(String idAula) throws SQLException{
        String deletar = "delete from aulas where idAula = ?";
